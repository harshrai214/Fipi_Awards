...
const TEMPLATE_FILENAME = "Best Managed Project of the Year Award_2025.xlsx";

const rowMapping = {
    organisationname: 6,
    schedule_weightage:16,
    cost_weightage:17,

    fatal_accident_rate:19,
    lost_time_injuries:21,
    incident_rate:23,
