...
const rowMapping = {
    ...
    accident_rate_2024: 30,
    lost_time_injuries_2024: 31,
    incident_rate_2024: 32,
...
const ExcelProdmore = () => {
    ...
    useEffect(() => {
        (async () => {
            try {
                const resp = await apiClient.get("/vw-productionmore-submitted/");
    ...
    const performExport = async (dataToWrite) => {
        ...
        dataToWrite.forEach((company, idx) => {
            ...
            const oil_production_2024 = company.organisation_name;
            const oil_production_2023 = company.organisation_name;
            const gas_production_2024 = company.organisation_name;
            const gas_production_2023 = company.organisation_name;
            const production_cost_2024 = company.organisation_name;
            const production_cost_2023 = company.organisation_name;
            const capex_2024 = company.organisation_name;
            const capex_2023 = company.organisation_name;
            const specific_energy_consumption = company.organisation_name;
            const specific_carbon_footprint = company.organisation_name;
            const accident_rate_2024 = company.organisation_name;
            const lost_time_injuries_2024 = company.organisation_name;
            const incident_rate_2024 = company.organisation_name;
