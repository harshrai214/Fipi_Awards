...
const RegistrationYM = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      useEffect(() => {
        ...
        try {
          const prefillRaw = sessionStorage.getItem('registrationYM_prefill');
          if (prefillRaw) {
            ...
            sessionStorage.removeItem('registrationYM_prefill');
          }
        } catch (err) {
          // ignore parse errors
        }
  ...
  const saveDraft = () => {
    try {
      ...
      localStorage.setItem('registrationYMDraft', JSON.stringify(draftToStore));
      alert('Draft Saved!');
    } catch (err) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            try {
        localStorage.removeItem('registrationYMDraft');
      } catch (err) {
        // ignore
      }
        } catch (err) {
